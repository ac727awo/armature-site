...
export default function About() {
    return (
          <>
                          ...
                          {[
                                      ...
                                      "sense there is a cleaner way to operate at this level",
                                                  ...
                                                  <div key={item} style={{ display: "flex", alignItems: "flex-start", gap: "16px", marginBottom: "16px" }}>
                                                                <span style={{ color: "#b8913a", fontSize: "14px", paddingTop: "2px", flexShrink: 0 }}>—</span>span>
                                                                <span style={{ fontFamily: BODY, fontSize: "16px", color: "#2e4e3a", lineHeight: "1.5" }}>{item}</span>span>
                                                  </div>div>
                                                ))}
            ...
            {/* LION SECTION — gold lion, bottom of page */}
                <section style={{ backgroundColor: "#ede8e0", borderTop: "1px solid rgba(28,56,40,0.08)" }}>
                        <div className="lion-section">
                                  <div style={{ padding: "80px 60px 80px 32px", maxWidth: "600px", marginLeft: "auto" }}>
                                              <p style={{ fontFamily: BODY, fontSize: "11px", color: "#b8913a", letterSpacing: "0.18em", textTransform: "uppercase", fontWeight: "600", margin: "0 0 24px 0" }}>Armature Wealth Office</p>p>
                                  ...
                                  <div className="lion-image" style={{ backgroundImage: "url(/images/lion-gold.png)" }} />
                        </div>div>
                </section>section>
