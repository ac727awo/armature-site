...
const phases = [
  {
    ...
    closing:
      "No assumptions. No prescriptions. Just a clear view of what exists, and how responsibility is currently distributed.",
  },
  {
    number: "02",
    ...
    closing:
      "Nothing needs to be \"wrong\" for this phase to matter. This step clarifies where coordination would make the most difference.",
  },
  {
    number: "03",
    ...
    closing:
      "The objective is coherence. When the framework is clear, decisions become easier and fewer.",
  },
  {
    number: "04",
    ...
    closing:
      "Final authority always stays with you. The difference is how much attention it requires.",
  },
  {
    number: "05",
    ...
    closing:
      "The goal is not activity. It is durability. Stability without stagnation. Clarity without constant input.",
  },
];
          ...
          {phases.map((phase, i) => (
            ...
            >
              ...
              <div>
                ...
                <ul
                  style={{ listStyle: "none", padding: 0, margin: "0 0 20px 0" }}
                >
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              >
                Everything starts with a diagnostic conversation. No pitch. No
                pressure.
              </p>
              <p
                style={{
              ...
              >
                We listen for how complexity is forming, where structure is
                lagging, and whether a governing system belongs in this phase of
                your life.
              </p>
              <p
                style={{
              ...
              >
                If it&apos;s not time yet, that will be clear. If it is, the
            ...
            <div>
              ...
              {[
                ...
                >
                  <span style={{ color: "#c9a84c", flexShrink: 0, paddingTop: "2px" }}>
                    —
                  </span>
                  <span
                    style={{
